...
public class StudentAdapter {
    ...
    public  static StudentDTO getStudentDTOfromStudent(Student studentdto) {
        List<Course> courses = studentdto.getCourses();
        StudentDTO student = new StudentDTO(studentdto.getId(), studentdto.getFirstName(), studentdto.getLastName(),
                studentdto.getEmail(), studentdto.getMajor(), studentdto.getJpa(), studentdto.getCourseTaken(), courses);
        return student;
